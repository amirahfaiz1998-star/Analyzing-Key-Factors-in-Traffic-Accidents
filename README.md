## Analyzing Key Factors in Traffic Accidents – A Data-Driven Approach

*Predicting accident severity and identifying high-risk conditions using machine learning and statistical analysis.*
